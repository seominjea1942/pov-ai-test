            ...
            <div className="sticky top-0 h-screen flex items-center overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-[1440px] px-6 lg:px-8 py-20 mx-auto">
                    <div className="max-w-[640px] w-full">
                        <h1 className="text-[36px] md:text-[48px] leading-[1.1] text-[#FFFFFF] mb-8 text-left">
                            {HERO_CONTENT.header}
                        </h1>
                        <p className="text-xl lg:text-2xl text-[#acb9bf] leading-relaxed max-w-2xl text-left">
                            {HERO_CONTENT.body}
                        </p>

                        <div className="mt-12 flex flex-col sm:flex-row items-center gap-6">
                            <button className="w-full sm:w-auto px-8 py-4 bg-white text-black hover:bg-white/90 transition-colors">
                                Get Started
                            </button>
                            <button className="w-full sm:w-auto px-8 py-4 text-white border border-white/10 hover:bg-white/5 transition-colors">
                                Talk With Expert
                            </button>
                        </div>
                    </div>
