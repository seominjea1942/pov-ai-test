...
export function HeroSection() {
    ...
    return (
        <div ref={containerRef} className="relative h-[300vh]">
            <div className="sticky top-[var(--header-height)] h-[calc(100vh-var(--header-height))] flex items-center overflow-hidden">
                {/* Background Spline */}
                <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
                    ...
                    />
                    {/* Gradient overlay */}
                    <div className="absolute inset-0 bg-gradient-to-r from-black via-transparent via-70% to-transparent pointer-events-none" />
                </div>

                {/* Content */}
                <div className="relative z-10 w-full max-w-[1440px] px-6 lg:px-8 py-20 mx-auto">
                    <div className="max-w-4xl">
                        <motion.h1
                            className="text-5xl lg:text-7xl font-['Moderat:Medium',sans-serif] leading-[1.1] text-[#dae2e5] mb-8 text-left"
                        ...
                        <motion.p
                            className="text-xl lg:text-2xl text-[#acb9bf] leading-relaxed max-w-2xl text-left"
                        ...
                        >
                            ...
                            <button className="px-8 py-4 text-white font-medium border border-white/10 hover:bg-white/5 transition-colors">
                                View Architecture
                            </button>
                        </motion.div>
                    </div>
